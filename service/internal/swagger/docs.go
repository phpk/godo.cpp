        ...
        "/api/v1/parameters": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Status of parameter (enabled, disabled)",
                        "name": "status",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.Parameter"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ParameterForm"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "schema.Parameter": {
            ...
            "properties": {
                ...
                "remark": {
                    "description": "Remark of parameter",
                    "type": "string"
                },
                "status": {
                    "description": "Status of parameter (enabled, disabled)",
