export default {
    'pages.layouts.userLayout.title': 'A fast, lightweight inference server to supercharge apps with local AI.',
    ...
    'pages.welcome.alertMessage': 'A fast, lightweight inference server to supercharge apps with local AI.',
